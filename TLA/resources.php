  ...
  <section class="links">
      <article>
        <div style="text-align: center;">
          ...
          <h3>Off-Site Resources</h3><br />
          <p>
            <a href="https://www.edsm.net/en/expeditions/summary/id/99/name/The+Long+Arf" class="btn btn-outline-primary btn-lg btn-block"><b>Official EDSM Expedition Page and Signups</b></a><br />
            <a href="https://forums.frontier.co.uk/threads/the-long-arf-an-expedition-by-the-hull-seals.543171/" class="btn btn-outline-primary btn-block btn-lg"><b>Official Frontier Developments Forum Thread</b></a><br />
            <a href="https://hullseals.space/knowledge/books/events/page/the-long-arf" class="btn btn-outline-primary btn-lg btn-block"><b>Seal Knowledge Base Posting</b></a><br />
          </p>
          <h3>Expedition Webpages</h3>
          <p>
            <a href="https://hullseals.space/TLA/about.php" class="btn btn-outline-success btn-lg btn-block"><b>About</b></a>
            <a href="https://hullseals.space/TLA/crew.php" class="btn btn-outline-success btn-lg btn-block"><b>Crew</b></a>
